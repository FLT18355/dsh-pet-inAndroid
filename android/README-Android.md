...
| 右键菜单（新版现代菜单） | ✅ 长按桌宠弹出 MD3 菜单（对话/动画集/速度/大小/功能侧面板/余额/更新/多开/快捷启动/设置/退出） |
...
> **v2.0.0 新增**
> - **边缘探头**：桌宠吸附到屏幕边缘探头张望（朝向决定贴左/右缘），开启期间只播放
>   待机动画，其它动画全部禁用，防止位置/朝向错乱；关闭后自动回到原位置与朝向。
> - **黄金回旋**：开启后点击桌宠会绕中心旋转一圈。
> - **点击音效自选**：默认音效（Q 弹）/ 鸭子音效二选一，宠物菜单「功能」面板与
>   设置-桌宠行为均可切换。
> - **宠物菜单美化 + 功能侧面板**：菜单分组美化；「功能」入口点击后在菜单右侧
>   （屏幕右侧放不下时自动放左侧）展开功能面板，新功能与原有功能开关集中切换。
